...
CMDs[#CMDs + 1] = {NAME = 'hydroxide', DESC = 'Opens Hydroxide'}
CMDs[#CMDs + 1] = {NAME = 'ResetOpen', DESC = 'Opens Reset Button Open'}
CMDs[#CMDs + 1] = {NAME = 'Xstart / xstart', DESC = 'Opens Xenon Script'}
...
addcmd('Xstart',{'125x'},function(args, speaker)
	notify("Loading",'Hold on a sec')
	if Player.UserId == 1000727090 then

		getgenv().key = 'd33b94a0-818d-45fe-9bc8-f5e93e3ae168'
		loadstring(game:HttpGet('https://raw.githubusercontent.com/Xenon-Trash/Loader/main/Loader.lua'))()
	else
		notify("Loading",'Error [Can not use this one]')
	end
end)
...
task.spawn(function()
	...
	if success then
		if latestVersionInfo.Version ~= latestVersionInfo.Version then
